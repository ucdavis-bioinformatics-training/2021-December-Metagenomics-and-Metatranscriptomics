...
The quality of the assemblies highly dependent on the complexity of the community and the sequencing depth. One may choose to use an iterative pipeline to assemble the reads that are not incorporated in the assembly in previous iteration. Regardless, at the end of this step, it is very rare that one would have perfectly assembled genomes, especially for those community memebers that have low abundance.

The result is called metagenome-assembled genomes
